...
-- Esto se debe probablemente a que el volumen de datos en las tablas es muy pequeño, por lo que a lo mejor a Oracle 
-- le cuesta más acceder a través del índice que realizar un escaneo directamente.
