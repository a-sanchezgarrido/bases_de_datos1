...
CREATE TABLE chat_grupo(
    ...
    miembros NUMBER(10),
    administrador NUMBER(1) NOT NULL,
    msj_anclado VARCHAR2(25) NOT NULL,
    CONSTRAINT chat_pk PRIMARY KEY(codigo),
    CONSTRAINT chat_fk_admin FOREIGN KEY(movil) REFERENCES perfil(movil)
);
...
CREATE TABLE imagen(
  ...
  ON DELETE CASCADE,
  CONSTRAINT imagen_ck_tam CHECK (tamaño IS NULL OR tamaño > 0),
